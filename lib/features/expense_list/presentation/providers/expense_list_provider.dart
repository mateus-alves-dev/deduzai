...
final expenseListProvider = StreamProvider<List<Expense>>(
  (ref) => ref.watch(expenseDaoProvider).watchByYear(DateTime.now().year),
);
...
final _receiptExpenseIdsProvider = StreamProvider<Set<String>>(
  (ref) => ref.watch(receiptDaoProvider).watchAllExpenseIdsWithReceipts(),
);
...
final ProviderFamily<AsyncValue<bool>, String> expenseHasReceiptProvider =
    Provider.family<AsyncValue<bool>, String>(
      (ref, expenseId) => ref
          .watch(_receiptExpenseIdsProvider)
          .whenData(
