...
final FutureProviderFamily<MonthlySummary, MonthPeriod> monthlySummaryProvider =
    FutureProvider.autoDispose.family<MonthlySummary, MonthPeriod>(
      (ref, period) async {
        ...
        final ytdExpenses = await dao.getByYearUpToMonth(
          period.year,
          period.month,
        );

        return ref
            .read(monthlySummaryServiceProvider)
            .computeMonthly(
