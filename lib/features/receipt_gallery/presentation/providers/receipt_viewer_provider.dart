...
final receiptsByExpenseProvider =
    StreamProvider.family<List<Receipt>, String>((ref, expenseId) =>
        ref.watch(receiptDaoProvider).watchByExpenseId(expenseId));

/// Streams the parent expense for metadata display (Spec 4.1).
final receiptViewerExpenseProvider =
...
final archivedReceiptsWithExpenseProvider =
    StreamProvider<List<({Receipt receipt, Expense expense})>>((ref) =>
